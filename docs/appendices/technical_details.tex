...
\section{PROTEUS SCHEMATIC}

\begin{figure}
\centering
\includegraphics[width=\figWidth{}]{proteus_schematic}
\caption{Proteus Schematic of Digital Clock System}%
\label{fig:proteus_schematic}
\end{figure}

\section{CLOCK PROGRAM}

\begin{lstlisting}[language=C, label=listing:clock_program]
/*
 * clock-program.c
 *
